...
<body>
    ...
    <section class="home" id="home">
        ...
        <div class="wrapper">
                ...
                <div class="content">
                    <span style="color: white;">never stop</span>
                    <h3>exploring</h3>
                    <p style="color: white;">Travel.com offers best deals on India tour packages.</p>
                    <a href="#category" class="btn" style="color: white;">get started</a>
                </div>
                </div>  
        </div>
    </section>
    ...
    <section class="footer">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <a href="mailto: krishnadevsidhharth@gmail.com"> <i class="fas fa-envelope"></i> krishnadevsidhharth8115@gmail.com </a>
                <a href="#"> <i class="fas fa-map"></i> Kerala, india - 688530 </a>
            </div>
    
            <div class="box">
                <h3>follow us</h3>
                <a href="https://www.facebook.com/krishnadev_krishnakumar"> <i class="fab fa-facebook-f"></i> facebook </a>
                <a href="https://www.instagram.com/krishnadev_krishnakumar"> <i class="fab fa-instagram"></i> instagram </a>
                <a href="https://www.linkedin.com/in/krishnadev_krishnakumar/"> <i class="fab fa-linkedin"></i> linkedin </a>
                <a href="https://github.com/krishnadev_krishnakumar"> <i class="fab fa-github"></i> github </a>
            </div>
        </div>
        <div class="credit">created by <span>Krish & Zid</span> | all rights reserved!</div>
    </section>
    <!-- footer section ends -->
